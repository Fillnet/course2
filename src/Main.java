...
//        SCHEDULE.addTask(new WeeklyTask("test1", "test1", LocalDateTime.now().plusHours(6), TaskType.WORK));
//        SCHEDULE.addTask(new MonthlyTask("test2", "test2", LocalDateTime.now().plusHours(3), TaskType.PERSONAL));
//        SCHEDULE.addTask(new YearlyTask("test3", "test3", LocalDateTime.now().plusHours(1), TaskType.WORK));
//        SCHEDULE.addTask(new DailyTask("test4", "test4", LocalDateTime.now().plusHours(11), TaskType.PERSONAL));
//        addTask(scanner);
//        printTaskForDay(scanner);
//        removeTask(scanner);
//    }
